...
=====================
Allows multiple independent projects under data/<project_name>/.
Each project gets its own input/, phase1_strategy/, ..., .cache/, .checkpoints/, etc.
"""
...
def select_project(skip_prompt: bool = False) -> str:
    ...
    If skip_prompt=True and an active project is saved, uses that without asking.
    """
    global _active_data_dir
